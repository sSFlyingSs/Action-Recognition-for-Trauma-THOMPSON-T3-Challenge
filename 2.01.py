...
def main():
    ...
    # ============================================================
    # Compute class weights (minority class gets higher weight) 
    # ============================================================
    labels_list = [lbl for (_,_,_,lbl) in dataset.samples]
    ...
    for i in range(num_classes):
        ...
        #weight = num_samples / (num_classes * count) #simple but can be very high for minority classes, leading to instability
        weight = math.sqrt(num_samples / (num_classes * count)) #sqrt to make it stabler 
